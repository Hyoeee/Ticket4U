...
public class MainController {
    ...
    public String add_ticket(@ModelAttribute Ticket ticket, BindingResult bindingResult, RedirectAttributes redirectAttributes) {
        ...
        if (ticket_to_add == null) {
            ...
            redirectAttributes.addFlashAttribute("error", "Error adding ticket. Duplicate event name.");
        }
